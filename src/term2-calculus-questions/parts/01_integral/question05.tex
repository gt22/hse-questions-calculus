...
\begin{enumerate}
    ...
    \begin{description}
        ...
        $ 0 \leqslant \int\limits_{1}^{n} p(p-1)t^{p-2} \{t\} (1-\{t\})\,dt \leqslant \frac{1}{4} \int\limits_{1}^{n} t^{p-2} = \frac{1}{4} \left. \frac{t^{p-1}}{p-1} \right|_{t = 1}^{t = n} = \frac{1}{4 (1-p)} \left( 1 - \frac{1}{n^{1-p}} \right) \leqslant \frac{1}{4(1-p)} $
        ...
        $ 0 \leqslant \int\limits_{1}^{n} p(p-1)t^{p-2} \{t\} (1-\{t\})\,dt \leqslant \frac{1}{4} \int\limits_{1}^{n} t^{p-2} = \frac{n^{p-1} - 1}{4(p-1)} = O(n^{p-1}) $
