...
\begin{theorem}[о дифференцировании произведения скаляра и векторной функции]\slashns
    ...
    $d_a(\lambda f) = d_a \lambda f(a) + \lambda(a) \cdot d_a f$
\end{theorem}
...
\begin{proof}\slashns
    ...
    \lambda(a) d_a f(h) + d_a \lambda (h) f(a)+ \lambda(a) o(||h||) + d_a \lambda(h)\cdot o(||h||) +\\+ o(||h||)\cdot o(||h||) + d_a \lambda(h) d_a f(h) + o(||h||)d_a f(h) + o(||h||)f(a)
    $
